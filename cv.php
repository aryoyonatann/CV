...
<body>
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col font-weight-bold">Nomor Induk Mahasiswa :</div>
        ...
        <div class="row">
            <div class="col font-weight-bold">No Telepon :</div>
        ...
        <div class="row">
            <div class="col font-weight-bold">Website :</div>
            <div class="col"><?php echo $_SESSION['web']; ?></div>
        </div>
        <div class="row">
            <div class="col font-weight-bold">Pendidikan :</div>
            <div class="col"><?php echo $_SESSION['pendidikan']; ?></div>
        </div>
        <div class="row">
            <div class="col font-weight-bold">Pengalaman Kerja :</div>
            <div class="col"><?php echo $_SESSION['pengalaman_kerja']; ?></div>
        </div>
        <div class="row">
            <div class="col font-weight-bold">Keterampilan :</div>
            <div class="col"><?php echo $_SESSION['keterampilan']; ?></div>
        </div>
        <div class="row">
            <div class="col font-weight-bold">PAS Foto :</div>
